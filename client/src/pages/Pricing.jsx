      ...
      try {
        ...
        const options = {
          ...
          handler : async function (response){
            const varifypay = await axios.post(ServerUrl + "/api/payment/varify", response, {withCredentials:true});

            dispatch(setUserData(varifypay.data.user));
            ...
            {plans.map((plan)=>{
                ...
                return(
                  ...
                  border
                    ...
                    {/* Price */}
                    <div className="mt-4">
                        <span className="text-3xl font-semibold text-emerald-600">{plan.price}</span>
