        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
          {
            [
              ...
              `}>
               ...
               <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2        border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center 
               ...
               <div className="pt-10 text-center">
                 ...
                 <p className="text-sm test-gray-500 leading-relaxed">{item.desc}</p>
               </div>
              </motion.div>
            ))
          }
                ...
                className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                      ...
                      <h3 className="font-semifold mb-3 text-xl ">{item.title}</h3>
