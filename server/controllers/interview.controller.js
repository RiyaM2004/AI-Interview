...
export const analyzeResume = async (req, res) => {
    try {
        ...
        //Extract text pages from all pages
        ...
        const messages = [
            {
                ...
                Scores the answer in these areas(0 to 10):
                1. Confidence - Does the answer should clear, confident and well-presented?
                ...
                - Can suggest improvment if needed.
                - Do NOT repeat the question.
                - Do not explain scoring.
                - Kepp tone professional and honest.
